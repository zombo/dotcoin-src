...
static const char *strDNSSeed[][2] = {
    {"dotcoin.su", "seed.dotcoin.su"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("dotcoin-dnsseed");
...
*/
    ...
    // dotcoin: mint proof-of-stake blocks in the background
    if (!NewThread(ThreadStakeMinter, pwalletMain))
        printf("Error: NewThread(ThreadStakeMinter) failed\n");

    // Generate coins in the background
    GenerateDotcoins(GetBoolArg("-gen", false), pwalletMain);
}
...
bool StopNode()
{
    ...
    if (vnThreadsRunning[THREAD_MINER] > 0) printf("ThreadDotcoinMiner still running\n");
