...
#ifndef DOTCOIN_MAIN_H
#define DOTCOIN_MAIN_H
...
static const uint256 hashGenesisBlockOfficial("0x0000061b427f5274648c8e7f73eae137fa408ed4a37bcf3b2c5e08614f07e3b3");
...
public:
    ...
    {
        // dotcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of dotcoins spent by this transaction.
    ...
    /** Amount of dotcoins coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // dotcoin: get transaction coin age
...
public:
    ...
    // dotcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // dotcoin: entropy bit for stake modifier if chosen by modifier
    ...
    // dotcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // dotcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // dotcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // dotcoin: trust score of block chain
    int nHeight;

    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // dotcoin: block index flags
    enum  
    {
